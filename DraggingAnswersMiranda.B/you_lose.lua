...
-- Create the you lose bkg music
local youLoseMusic = audio.loadSound("Sounds/youLoseSound.mp3")
...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then
        ...
        youLoseMusicChannel = audio.play(youLoseMusic)
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then
        ...
        audio.stop(youLoseMusicChannel)
